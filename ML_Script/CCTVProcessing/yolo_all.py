...
ap.add_argument("-i", "--input",
                help="path to input video", default='videoCUT.mp4')
...
print("Objects which will be detected :- ")

for obje in LABELS:
    print(obje)

vehicles = ['car', 'bus', 'truck', 'person']
...
while True:
    ...
    if len(idxs) > 0:
        ...
        # cv2.rectangle(frame, (15, 730), (155, 811), (255, 0, 0), 2)
        for i in range(9):
        ...
        for i in idxs.flatten():
            ...
            # print("Detected :- ", LABELS[classIDs[i]], end=" ")
            label_keys[LABELS[classIDs[i]]] += 1
            ...
            if True:
                ...
                if 685 < a < 830 and 730 < b < 811:
                    park = 1
                if 15 < a < 155 and 730 < b < 811:
                    park2 = 1
        # print(park, "---", park2)
        # print(db.get())
            for po_lab in label_keys:
                if(label_keys[po_lab] > 0):
                    print(po_lab, " : ", label_keys[po_lab], end=" ")
            print("\n-----------------------------------------\n")
